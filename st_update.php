        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    ...
                    <div id="post" >
                        <form method ="post" >
                            <p>Text Update here:  <br /><textarea class="form-horizontal" style="height:250px; width: 885px;"  name="textstatus" placeholder="Status"></textarea><br />
                                    <input class="btn btn-primary btn-lg" type="submit" value="Post"> </p>
                        </form>
                        <?php
                        if (isset($_POST['textstatus'])) {

                            $data = ["message" => $_POST['textstatus']];
                            $request = $fb->post('/me/feed', $data, $_SESSION['accessToken']);
                            $respond = $request->getGraphUser();
                            echo "Successfully posted STATUS on Facebook with ID: " . $respond['id'];
                        }
                        ?>
