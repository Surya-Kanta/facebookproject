            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    ...
                    <div id="post" >
                                        ...
                                        <form method="post" >
                                            <p>Link Update here:  <br />
                                                <textarea class="form-group" name="message" placeholder="Message" style="height:250px; width: 885px;"></textarea>
                                                    <input class="form-control" type="text" name="link" placeholder="Link">
                                                    <input class="btn btn-danger btn-lg" type="submit" value="Post">
                                            </p>
                                        </form>
                                        <?php
                                        if (isset($_POST['message']) && isset($_POST['link'])) {
                                            ...
                                            echo "Successfully posted LINK on Facebook with ID: " . $respond['id'];
                                        }
                                        ?>
