                ...
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <h2><?php
                                if (isset($_SESSION['accessToken'])) {
                                    echo $_SESSION['name'] . ', the list of your Friends who are using this app...';
                                } else {
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                                <tr><th>Friendlist fetched from Profile</th></tr>
                            </thead>
                            <tbody>
                        <?php
                        try {
                            ...
                            if ($fb->next($friends)) {
                                ...
                                foreach ($allFriends as $key) {
                                    echo "<tr class='active'><td>".$key['name']."</td></tr>";
                                }
                            } else {
                                $allFriends = $friends->asArray();
                                $totalFriends = count($allFriends);
                                foreach ($allFriends as $key) {
                                    echo "<tr class='success'><td>".$key['name']."</td></tr>";
                                }
                        ...
                        echo '</tbody></table>';
                        echo "Total friends who are using it: ".$totalFriends;
